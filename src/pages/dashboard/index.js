...
/* REMOVIDO: ProfileHeader não é mais necessário, pois o h2 "Meus Dados" e o botão foram movidos */
...
const UserDashboard = () => {
  ...
  return (
    <Layout>
      ...
      <DashboardContainer>
        {/* O título da página agora é "Meu Perfil" */}
        <Title>Meu Perfil</Title>
        <ProfileCard>
          <Avatar>{userData.name.charAt(0)}</Avatar>
          <ProfileContent>
            {/* Removido o h2 "Meus Dados" daqui */}
            <ProfileInfo>
